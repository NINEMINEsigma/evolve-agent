...
def generate_benchmark(benchmark_dir: Path, skill_name: str = "", skill_path: str = "",
                       executor_model: str = "unknown", analyzer_model: str = "unknown") -> dict:
    """
    ...
    # Actual runs per configuration (max across configurations)
...
def main():
    ...
    parser.add_argument(
        "--executor-model",
        default="unknown",
        help="Model used to execute the runs (recorded in metadata)"
    )
    parser.add_argument(
        "--analyzer-model",
        default="unknown",
        help="Model used to analyze the results (recorded in metadata)"
    )
    parser.add_argument(
        "--output", "-o",
        type=Path,
    ...
    benchmark = generate_benchmark(
        ...
        args.executor_model, args.analyzer_model,
    )
